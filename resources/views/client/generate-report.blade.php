...
<div class="col-sm-9 col-md-10 main-content" style="margin-top: 5px;">
    ...
    <div class="top10">
        ...
        <form action="{{ route('payments.filterPayments') }}" class="form-inline filter" role="form" method="post" accept-charset="utf-8">
            @csrf
            <!-- Form content -->
            ...
            <div class="row">
                ...
                <div class="col-md-2 form-group">
                    ...
                    <input type="date" class="form-control input-xs datepicker" name="from" id="date1" placeholder="Date From" size="18" value="{{ old('from') }}"/>
                </div>

                <div class="col-md-2 form-group">
                    <label for="date2">Date To</label>
                    <input type="date" class="form-control input-xs datepicker" name="to" id="date2" placeholder="Date To" size="18" value="{{ old('to') }}"/>
                </div>
                <div class="col-md-2 form-group">
    ...
    <tbody>
        ...
        @foreach($payments as $payment)
            <tr>
                ...
                {{-- <td>
                    <button class="btn btn-danger btn-xs" onclick="delet({{ ++$sl }})">Delete</button>
                </td> --}}
            </tr>
        @endforeach
