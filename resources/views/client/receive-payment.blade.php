        ...
        <tbody>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <iframe frameborder="0" height="300" src="{{ route('payment_history',$client->id) }}"style="border: 1px solid rgb(208, 208, 208);" width="900"></iframe>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                <td colspan="2">
                    <form action="{{ route('client.receive-payment', $client->id) }}" method="post" id="form" name="paymentform" accept-charset="utf-8">
                        @csrf
                        <table class="table">
                            <tbody>
                                <tr>
